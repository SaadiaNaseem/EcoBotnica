...
import ProductItem from '../compononts/ProductItem'
...
const Collection = () => {
  ...
  useEffect(() => {
    applyFilter();
  }, [products, search, category, subCategory, sortType, showSearch]);
      ...
      <div>
        <div className='min-w-60'>
          ...
          >
            FILTERS
            <img
              className={`h-3 sm:hidden transform transition-transform duration-300 ${showFilter ? 'rotate-90' : 'rotate-0'}`}
          ...
          <div className={`border border-gray-300 pl-5 py-3 mt-6 ${showFilter ? '' : 'hidden'} sm:block`}>
            ...
            <div className='flex flex-col gap-2 text-sm font-light text-gray-700'>
              ...
              <p className='flex gap-2'>
                <input className='w-3' type="checkbox" value="Plant" onChange={toggleCategory} /> Plant
              </p>
            </div>
          </div>
